...
export class LazyModalService {
  ...
  async openTrackCreateModal(config?: MatDialogConfig): Promise<MatDialogRef<any>> {
  ...
  async openTrackEditModal(config?: MatDialogConfig): Promise<MatDialogRef<any>> {
  ...
  async openTrackDeleteModal(config?: MatDialogConfig): Promise<MatDialogRef<any>> {
  ...
  async openTrackUploadModal(config?: MatDialogConfig): Promise<MatDialogRef<any>> {
